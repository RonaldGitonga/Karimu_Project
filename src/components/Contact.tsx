                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      <div className="input-with-icon">
                        ...
                        <input type="text" className="form-control" name="name" placeholder="First Name" required={true} />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-12">
                    <div className="form-group">
                      <div className="input-with-icon">
                        ...
                        <textarea className="form-control" name="message" placeholder="Write Message..." style={{ height: "180px" }} required={true}></textarea>
                      </div>
                    </div>
                  </div>
